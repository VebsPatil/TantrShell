...
const screenshotUrl = 'https://lh3.googleusercontent.com/aida/ADBb0ui_H2Xwwv-iqye_TcZ6Bhq5MMFne4SdBDmvRCmR0t4rIscccxhl-hOhNDrkMm8MTqPotDxIUIvd94gISyE3XUNC8Msm_aVjh-z9ZAwRgNoH9d1z_nh-EFWQq8ZpKsMHBfuL_Jq1azEWp5W6j7zQWqPNOCKQsIl1OvMQIlVM98RIK8rQ7BlINdkUrNG_ELlCgN-CswvQLy2WbCa9qECSPlqzDLr6AcruSmMBRbBhxtWlC354RntwLpi0lIE';

const features = [
  { icon: '📄', title: 'Auto Invoicing', desc: 'Generate professional invoices automatically with customizable templates, branding, and batch processing.' },
  { icon: '🧮', title: 'GST/Tax Engine', desc: 'Built-in GST, VAT, and sales tax calculation with compliance-ready reporting and e-filing integration.' },
  { icon: '💰', title: 'Payment Tracking', desc: 'Real-time payment status updates, aging reports, automated reminders for overdue invoices, and reconciliation.' },
  { icon: '📊', title: 'Financial Reports', desc: 'Profit & loss, balance sheet, cash flow statements, and custom report builder with PDF/Excel export.' },
  { icon: '🔄', title: 'Recurring Billing', desc: 'Subscription management, automatic renewal, proration support, and dunning management for failed payments.' },
  { icon: '🏦', title: 'Multi-Currency', desc: 'Support for 50+ currencies, real-time exchange rates, and localized invoice formatting for global commerce.' },
];
    ...
    <div className="product-deploy-page" style={{ '--product-accent': '#FFD700', '--product-accent-rgb': '255, 215, 0' }}>
      ...
      <section className="pdp-screenshot-section">
        <div className="pdp-screenshot-wrapper" style={{ boxShadow: '0 30px 80px rgba(255,215,0,0.12)' }}>
          ...
          <img src={screenshotUrl} alt="Billing & Invoicing Dashboard" className="pdp-screenshot" loading="lazy" />
        </div>
      </section>
