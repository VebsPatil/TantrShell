...
const screenshots = [
  ...
  { src: 'https://lh3.googleusercontent.com/aida/ADBb0ugYa9Ycfzc6di5iwDf5K7orc4m5dMj7TIvrrV87RfdqgXCOhkklcW1PKG_cFbFVc1Vtr4twUCB8epZCv4sYfPJ1fmroRaLu-Ult4F_s3tfLIks6zSbGHrHdlP1hitRuNxfuFa_rJX_j4bz4_BjLmz18tSClCrbcpG9fBnDFa0N946AlmXKOcffxxn5ZiG2MsI-2-VpV0UgzaEGd6mhjkbB9SqLDUzD0xvVr0_iAg2ZEi2ve0Sr8tgFKqEY', alt: 'Lead Pipeline' },
  { src: 'https://lh3.googleusercontent.com/aida/ADBb0ugYa9Ycfzc6di5iwDf5K7orc4m5dMj7TIvrrV87RfdqgXCOhkklcW1PKG_cFbFVc1Vtr4twUCB8epZCv4sYfPJ1fmroRaLu-Ult4F_s3tfLIks6zSbGHrHdlP1hitRuNxfuFa_rJX_j4bz4_BjLmz18tSClCrbcpG9fBnDFa0N946AlmXKOcffxxn5ZiG2MsI-2-VpV0UgzaEGd6mhjkbB9SqLDUzD0xvVr0_iAg2ZEi2ve0Sr8tgFKqEY', alt: 'Sales Analytics' },
];

const features = [
  { iconSvg: 'lead-pipeline', title: 'Lead Pipeline', desc: 'Visual kanban boards for lead tracking through stages — from first contact to deal closure with drag-and-drop.' },
  { iconSvg: 'comm-hub', title: 'Communication Hub', desc: 'Unified inbox for emails, calls, and messages. Full conversation timeline with each contact and deal.' },
  { iconSvg: 'sales-analytics', title: 'Sales Analytics', desc: 'Real-time conversion metrics, win/loss analysis, sales velocity tracking, and forecasting dashboards.' },
  { iconSvg: 'contact-mgmt', title: 'Contact Management', desc: 'Rich contact profiles with social data, interaction history, tags, and smart segmentation.' },
  { iconSvg: 'deal-tracking', title: 'Deal Tracking', desc: 'Custom deal stages, weighted pipeline value, close probability, and automated follow-up sequences.' },
  { iconSvg: 'email-campaigns', title: 'Email Campaigns', desc: 'Templated outreach, drip campaigns, open/click tracking, and A/B testing for higher conversions.' },
];
        ...
        <div className="pdp-features-grid">
          {features.map((f, i) => (
            <div key={i} className="pdp-feature-card" style={{ '--card-accent': '#FF2D55' }}>
              <div className="pdp-feature-icon"><FeatureIcon name={f.iconSvg} color="#FF2D55" /></div>
